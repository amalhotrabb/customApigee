...
#curl -u $username:$password $url/v1/o/$org/developers/raja@osscube.com/apps/thomas-app -X DELETE

#curl -u $username:$password $url/v1/o/$org/developers/joe@weathersample.com/apps/joe-app -X DELETE

echo "Deleting Developers"

curl -u $username:$password $url/v1/o/$org/developers/raja@osscube.com -X DELETE
